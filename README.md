...
- Реализовть механизм, позволяющий пользователю получать информацию, которая была передана в сессии до его присоединения.
- Реализовать мобильное приложение на android, с возможностью создавать сессиии, присоединятся, отправлять заказы, смотреть дпо инфу о блюдах
---
...
4. **S3 Object Storage**. Облачное хранилище изображений блюд, можно с легкостью масштабировать.
